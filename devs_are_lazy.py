...
def index():
    ...
    open_pull_requests, closed_pull_requests, pull_request_ratios, open_issues, closed_issues, issue_ratios = ([] for _
                                                                                                               in
                                                                                                               range(6))
    ...
    return render_template('index.html', open_pull_requests=open_pull_requests,
                           closed_pull_requests=closed_pull_requests, pull_request_ratios=pull_request_ratios,
                           open_issues=open_issues, closed_issues=closed_issues, issue_ratios=issue_ratios,
                           labels=languages)
